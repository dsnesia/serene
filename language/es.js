...
const translations = {
    ...
    name: 'Nombre',
    noMention: 'Silakan sebutkan satu pengguna',
    ...
    newcode: (usedPrefix) => `Bien! ya puedes usar *${usedPrefix}serbot* para pedir nuevo codigo QR`,
    ...
    notext: 'Repita agregando un text',
    textSe: 'Separe el text con un',
    reply: 'Menanggapi pesan tersebut',
    ...
    isNan: 'La Jumlah debe ser un número válido',
    voucher: 'Comprobante',
    buy: 'Comprado',
    buyCount: 'Jumlah comprada',
    spent: 'Gastado',
    ...
    langList: 'Seleccione el bahasa que desea utilizar\n\n≡ *bahasas disponibles*',
    expire: 'Expira en',
    ping: 'Velocidad',
    uptime: 'Tiempo Activo',
    NSgc: (usedPrefix) => `El grupo no admite contenido nsfw\nUsa este grupo\n${NSgc}\n\nSi eres admin habilita con\n*${usedPrefix}enable* nsfw`,
    ...
    tradList: 'Lista de bahasas Admitidos',
